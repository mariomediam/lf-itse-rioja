...
env = environ.Env(
    ...
    QR_VERIFICACION_HABILITADO=(bool, False),
    QR_URL_VERIFICAR_LICENCIA=(str, ''),
    QR_URL_VERIFICAR_ITSE=(str, ''),
)
...
QR_VERIFICACION_HABILITADO  = env('QR_VERIFICACION_HABILITADO')
QR_URL_VERIFICAR_LICENCIA   = env('QR_URL_VERIFICAR_LICENCIA')
QR_URL_VERIFICAR_ITSE       = env('QR_URL_VERIFICAR_ITSE')
